var nil1;
  var nil2;
     var op;
        ...
        function pilTambah(){
            op = 'add';
            nil1 = parseFloat(document.querySelector('#layar').value);//saya mengunakan parseFloat bukan parseInt karena untuk operasi desimal saya tedapat button desimal untuk itu saya juga menggunakan parseFloat
            ...
            function plusMinus(){
                ...
                if(cek<0){
                    document.querySelector('#layar').value = cek * (-1);
                        ...
                        document.querySelector('#layar').value = cek * (-1);
                        //document.querySelector('#layar').value = "Masukkan angka dahulu";
                        }
